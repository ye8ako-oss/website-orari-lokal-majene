          ...
          <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">
                Role:{" "}
                <span className="font-semibold text-[#001f3f]">{userRole}</span>
              </p>
            </div>
        ...
        <div className="rounded-2xl bg-white p-5 shadow-sm sm:p-6">
          <div className="mb-6">
            ...
            <p className="mt-1 text-sm leading-6 text-gray-500">
              Pilih jenis konten yang ingin ditambahkan atau dikelola.
            </p>
          </div>
              ...
              <div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      Kelola akun admin website ORARI Lokal Majene.
                    </p>
                  </div>
                </div>

                <p className="mt-4 text-sm leading-6 text-gray-500">
                  Kelola akun administrator dan hak akses sesuai kebutuhan
                  operasional website.
                </p>
              </div>
